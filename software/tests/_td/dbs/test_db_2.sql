...
insert into extra(gene, genename, `n.snps.in.model`, `pred.perf.R2`, `pred.perf.pval`, `pred.perf.qval`) values ("ENSG00000153814.7", "JAZF1", 25, 0.0678427838866996, 5.2052946696116e-07, 6.14282057719623e-07);
