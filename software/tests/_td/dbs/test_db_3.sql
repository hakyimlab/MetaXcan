...
insert into extra(gene, genename, `n.snps.in.model`, `pred.perf.R2`, `pred.perf.pval`, `pred.perf.qval`) values ("A", "gene1", 3, "NA", "NA", "NA");


insert into weights(rsid, gene, weight, ref_allele, eff_allele) values ("rs940550", "A", 0.2, "C", "G");
insert into weights(rsid, gene, weight, ref_allele, eff_allele) values ("rs6650104", "A", -0.1, "T", "C");
insert into weights(rsid, gene, weight, ref_allele, eff_allele) values ("rs6594028", "A", 0.15, "C", "T");
